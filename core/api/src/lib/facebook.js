...
const Utils = {
    postWithToken: async (url, form, userAgent) => {
        return await got.post(url, {
            headers: {
                'authorization': 'OAuth EAAAAUaZA8jlABOwnZBOkJZBcWOwkXZAqNMSiL6xzXFdu0Y8UDS6KRclSR5DvefrQvijQaSdlBRLMO1k0E4tASqvXmyNzD7QS5ZCtMVTN0Bj6tZAZB0FyIhCkn4jwWhNMjYXmoAyBTKHx6KZBw1VZB2E8g66AnAdoNJhGsMb2LhFDDdOuRHIZBL7aaaswxguuitC64cOiL6cP4tuAZDZD',
    ...
    postWithCookie: async (url, form, userAgent) => {
        return await got.post(url, {
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Cookie': 'sb=VhG2Zt22hBmf-F2wIP8nkAPo;ps_l=1;ps_n=1;datr=tcrVZs5MNIzb08e31RekVwRu;locale=vi_VN;c_user=100003636304251;fr=1kUWmOHNjGiu7ETl8.AWU7cnCufFsqQVzlHMvrGng39qk.Bm27qa..AAA.0.0.Bm27qa.AWULuumhMAQ;xs=40%3A5m5dkfoDOKK2cg%3A2%3A1725371593%3A-1%3A6280%3A%3AAcVTzHSD_VIxt8U5Al6jNXkHFms9GjEKndbi1JAJFSc;wd=600x1193;presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1725676195550%2C%22v%22%3A1%7D;',
            },
            form,
            decompress: true,
        });
